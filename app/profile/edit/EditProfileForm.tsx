...
// Libyan mobile numbers: 9 digits starting with 9, with or without the 218
// country code / a leading 0 — accept whatever the user typed and check the
// trailing local number. WhatsApp is optional here, so an empty field is
// valid too. Instant check — no more "test the wa.me link" round trip.
...
export default function EditProfileForm({
  ...
  const whatsappTouched = whatsapp.trim() !== "";
            ...
            <div>
              ...
              <input
                ...
                className={`${input} text-left placeholder:text-right ${
                  whatsappTouched && !whatsappValid ? "border-red-400 focus:border-red-500" : ""
                }`}
              />
              {whatsappTouched && !whatsappValid ? (
                <p className="mt-1.5 text-xs text-red-500">
                  أدخل رقم واتساب ليبي صحيح (مثال: 218912345678)
                </p>
              ) : (
